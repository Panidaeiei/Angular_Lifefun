export const environment = {
    production: false,
     apiBaseUrl: 'https://flim.k0n4n4p4.site/api',
    // apiBaseUrl: 'http://localhost:3000/api',
     // กำหนด baseUrl สำหรับทุก service
    firebase: {
        ...
        // measurementId: "G-XE6C6C3DQM" // ใส่ถ้าต้องการใช้ Analytics
    },
    vapidKey: "BFhy-5H3oHusW2RnT-Ro0n9d1-2l9qnpFUMD3AByJH4pjZKVDUd7Xve1cJkNSlXYVD-ySWAPDBEj7MfRg3vQr2I"
};
