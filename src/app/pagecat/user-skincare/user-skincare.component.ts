...
@Component({
  ...
  templateUrl: './user-skincare.component.html',
  styleUrl: './user-skincare.component.scss'
})
export class UserSkincareComponent {
  ...
  loadPosts(): void {
    this.postService.getPostsSkincare().subscribe(
      (posts: ShowPost[]) => {
        this.posts = posts;
      },
      (error) => {
